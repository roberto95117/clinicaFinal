...
/**
 * Servlet implementation class ServletViewChangePass
 */
@WebServlet("/ServletViewChangePass.do")
public class ServletViewChangePass extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletViewChangePass() {
        super();
