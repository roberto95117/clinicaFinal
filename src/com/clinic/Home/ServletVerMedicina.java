...
/**
 * Servlet implementation class ServletVerMedicina
 */
@WebServlet("/ServletVerMedicina.do")
public class ServletVerMedicina extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletVerMedicina() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Medicina> medicamentos=new ArrayList<Medicina>(Conexion.getInstancia().listaMedicinas("from Medicina where existe=1"));
		...
		request.setAttribute("medicinas", medicamentos);
		request.setAttribute("pacientes", pacientes);
		request.setAttribute("doctores", doctores);
		des=request.getRequestDispatcher("Medicina/Lista.jsp");
